    ...
    <>
                ...
                <div className="slide-1 home-slider">
                    <div>
                        <div className="home  text-center">
                            <img src="../assets/images/home-banner/1.jpg" alt="" className="bg-img blur-up lazyload" />
                ...
                <div className="row partition2">
                        ...
                        <a href="/">
                            <div className="collection-banner p-right text-center">
                                <div className="img-part">
                                    <img src="../assets/images/sub-banner1.jpg" className="img-fluid blur-up lazyload bg-img"
                                        alt="" />
                                </div>
                    ...
                    <div className="col-md-6">
                        <a href="/">
                            <div className="collection-banner p-right text-center">
                                <div className="img-part">
                                    <img src="../assets/images/sub-banner2.jpg" className="img-fluid blur-up lazyload bg-img"
                                        alt="" />
                                </div>
                                <div className="contain-banner">
                                    <div>
        ...
        <section className="p-0">
            <div className="full-banner parallax text-center p-left">
                <img src="../assets/images/parallax/1.jpg" alt="" className="bg-img blur-up lazyload" />
                <div className="container">
                    <div className="row">
                        <div className="col">
                        ...
                        <div className="slide-3 no-arrow slick-default-margin">
                            <div className="col-md-12">
                                <a href="/">
                                    <div className="classic-effect">
                                        <div>
                                            <img src="../assets/images/blog/1.jpg" className="img-fluid blur-up lazyload bg-img"
                                                alt=""/>
                                        </div>
                                        <span></span>
                                    </div>
                            ...
                            <div className="col-md-12">
                                <a href="/">
                                    <div className="classic-effect">
                                        <div>
                                            <img src="../assets/images/blog/2.jpg" className="img-fluid blur-up lazyload bg-img"
                                                alt=""/>
                                        </div>
                                        <span></span>
                                    </div>
                            ...
                            <div className="col-md-12">
                                <a href="/">
                                    <div className="classic-effect">
                                        <div>
                                            <img src="../assets/images/blog/3.jpg" className="img-fluid blur-up lazyload bg-img"
                                                alt=""/>
                                        </div>
                                        <span></span>
                                    </div>
                            ...
                            <div className="col-md-12">
                                <a href="/">
                                    <div className="classic-effect">
                                        <div>
                                            <img src="../assets/images/blog/4.jpg" className="img-fluid blur-up lazyload bg-img"
                                                alt=""/>
                                        </div>
                                        <span></span>
                                    </div>
                            ...
                            <div className="col-md-12">
                                <a href="/">
                                    <div className="classic-effect">
                                        <div>
                                            <img src="../assets/images/blog/5.jpg" className="img-fluid blur-up lazyload bg-img"
                                                alt=""/>
                                        </div>
                                        <span></span>
                                    </div>
